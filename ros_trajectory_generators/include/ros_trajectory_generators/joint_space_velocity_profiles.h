#ifndef JOINT_SPACE_VELOCITY_PROFILE_H
#define JOINT_SPACE_VELOCITY_PROFILE_H
...
namespace joint_space_vel_prof{
   ...
   public:
      ...
      cubicPolynomial(const KDL::Chain& kdl_chain);
   ...
   public:
      ...
      quinticPolynomial(const KDL::Chain& kdl_chain);
   ...
   public:
      ...
      bangBang(const KDL::Chain& kdl_chain);
   ...
   public:
      ...
      trapezoidal(const KDL::Chain& kdl_chain);
